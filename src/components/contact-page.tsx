...
import data from "../data/contact-page-data";
...
export const BackgroundBeams = ({ className }: { className?: string }) => {
  const paths = [
    "M-387 -181C-387 -181 -319 224 145 351C609 478 677 883 675 883",
  ...
  return (
    <div
      className={cn(
        "absolute h-full w-[80%] inset-0 ml-auto mr-auto [mask-size:40px] [mask-repeat:no-repeat] flex items-center justify-center",
        className
      )}
    >
      <svg
